...
def validate_html_basic(file_path):
    ...
    try:
        ...
        required_elements = ['{% extends "templates/web.html" %}', '{% block page_content %}', '{% endblock %}']
...
def main():
    ...
    python_files_functions = {
        "verenigingen/templates/pages/bank_details.py": [
            "get_context", "update_bank_details", "has_website_permission"
        ],
        "verenigingen/templates/pages/bank_details_confirm.py": [
            "get_context", "process_bank_details_update", "has_website_permission"
        ],
        "verenigingen/templates/pages/bank_details_success.py": [
            "get_context", "has_website_permission"
        ]
    }
