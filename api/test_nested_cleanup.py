...
def test_nested_cleanup():
    ...
    eb_accounts = frappe.get_all("Account", 
        filters={
            "company": company,
    ...
    problem_account = frappe.db.get_value("Account", 
        {"account_name": "EIGEN VERMOGEN - NVV", "company": company},
        ["name", "lft", "rgt", "is_group"], as_dict=True)
    ...
    remaining_accounts = frappe.get_all("Account", 
        filters={
            "company": company,
            "eboekhouden_grootboek_nummer": ["is", "set"]
        },
