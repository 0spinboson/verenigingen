...
def show_department_tree(parent=None, level=0):
    ...
    for dept in departments:
        ...
        approvers = frappe.get_all("Department Approver",
...
def show_migration_summary():
    ...
    volunteers_without_employees = frappe.db.count("Volunteer", 
...
def test_expense_approval_chain(volunteer_email):
    ...
    # Get volunteer
    volunteer = frappe.db.get_value("Volunteer", {"email": volunteer_email}, 
        ["name", "employee_id"], as_dict=True)
