...
def setup_member_portal_home():
    ...
    try:
        from verenigingen.utils.member_portal_utils import set_all_members_home_page, get_member_portal_stats
        ...
        if result.get("success"):
            print(f"✅ SUCCESS: Updated {result['updated_count']} out of {result['total_members']} member users")
