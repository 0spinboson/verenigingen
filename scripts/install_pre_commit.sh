  ...
  - repo: local
    hooks:
      - id: run-quick-tests
        ...
        entry: bash -c 'cd /home/frappe/frappe-bench && bench --site dev.veganisme.net execute verenigingen.tests.test_runner_simple.run_quick_tests || echo "Tests failed but continuing commit"'
        language: system
