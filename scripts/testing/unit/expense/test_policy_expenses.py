...
import frappe
from verenigingen.templates.pages.volunteer.expenses import submit_expense, is_policy_covered_expense
...
def test_policy_covered_expenses():
    ...
    non_policy_categories = frappe.get_all("Expense Category", 
        filters={"policy_covered": 0}, 
        fields=["name", "category_name"], 
        limit=1)
