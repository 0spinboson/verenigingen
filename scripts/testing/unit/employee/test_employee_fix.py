...
def test_employee_creation():
    ...
    try:
        ...
        if not volunteer:
            return {
                "success": False,
                "message": "No volunteers without employee_id found for testing"
            }
        ...
        if employee_id:
            ...
            return {
                "success": False,
                "message": "Employee creation returned None"
            }
...
def test_designation_creation():
    ...
    try:
        ...
        return {
            "success": True,
            "message": f"Successfully created designation: {designation_name}"
        }
        
    except Exception as e:
        return {
            "success": False,
            "message": f"Error creating designation: {str(e)}"
        }
