        ...
        if result.get('success'):
            ...
            for test_result in result['results']:
                if 'error' not in test_result:
                    ...
                    print(f"    Application period: {test_result['application_invoice_period']['start']} to {test_result['application_invoice_period']['end']}")
        ...
        for scenario in scenarios:
            if mt.subscription_period == scenario["name"]:
                try:
                    ...
                    print(f"  Application period: {dates_with_app['application_invoice_period']['start']} to {dates_with_app['application_invoice_period']['end']}")
                    ...
                    # Verify alignment
                    if dates_with_app['subscription_start_date'] == dates_with_app['application_invoice_period']['end'] + frappe.utils.timedelta(days=1):
