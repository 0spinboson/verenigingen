    ...
    try:
        ...
        try:
            ...
            if member_doc.membership_fee_override == 30.00:
                ...
                if member_doc.fee_override_by == "Administrator":
                    ...
                    print(f"❌ FAIL: Override Set By shows {member_doc.fee_override_by}, should be Administrator")
                    return False
            else:
        ...
        try:
            ...
            if hasattr(member_doc, 'membership_fee_override'):
                ...
                print("ℹ️  Regular user can read fee override field (may be expected depending on permission setup)")
            else:
