...
def analyze_filtering_logic():
    ...
    test_records = [
        ...
        {"name": "AMEND-2025-00007", "member": "MEM-002", "status": "Draft", "should_match": False},  # different member
    ]
    ...
    for record in test_records:
        ...
        print(f"  {status_icon} {record['name']}: {record['status']} (member: {record['member']}) -> {'MATCH' if expected_match else 'NO MATCH'}")
