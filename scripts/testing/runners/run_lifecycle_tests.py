...
def run_lifecycle_test():
    ...
    if not os.path.exists(os.path.join(app_dir, "verenigingen", "tests", "workflows", "test_member_lifecycle.py")):
    ...
    test_command = [
        ...
        "run-tests",
        "--app", "verenigingen",
        "--module", "verenigingen.tests.workflows.test_member_lifecycle"
    ]
