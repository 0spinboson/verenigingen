...
def main():
    ...
    parser.add_argument('--suite', choices=['core', 'report', 'legacy', 'integration', 'all'], 
    ...
    test_suites = {
        'core': {
            'name': 'Core ERPNext Integration Tests',
            'classes': [TestERPNextExpenseIntegration]
        },
        'report': {
        ...
        'integration': {
            'name': 'Edge Cases and Integration Tests',
            'classes': [TestERPNextExpenseEdgeCases]
        },
        'all': {
