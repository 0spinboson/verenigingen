...
def run_chapter_membership_regression_tests():
    ...
    try:
        # Import test modules
        from verenigingen.tests.test_volunteer_expense_validation_regression import TestVolunteerExpenseValidationRegression
        from verenigingen.tests.test_get_user_volunteer_record_unit import TestGetUserVolunteerRecordUnit
        from verenigingen.tests.test_chapter_membership_validation_edge_cases import TestChapterMembershipValidationEdgeCases
        ...
        test_suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestVolunteerExpenseValidationRegression))
        ...
        test_suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestChapterMembershipValidationEdgeCases))
