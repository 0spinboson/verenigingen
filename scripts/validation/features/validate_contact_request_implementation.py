...
def check_doctype_structure():
    ...
    doctype_path = "/home/frappe/frappe-bench/apps/verenigingen/verenigingen/verenigingen/doctype/member_contact_request"
...
def check_javascript_integration():
    ...
    js_files = [
        ("Member JavaScript", f"{js_path}/member.js")
    ]
...
def check_test_files():
    ...
    test_files = [
        ("Integration Tests", f"{test_path}/test_member_contact_request_integration.py")
    ]
