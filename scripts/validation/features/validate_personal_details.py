...
def main():
    ...
    required_functions = [
        "get_context", "has_website_permission", "update_personal_details", 
        "validate_name_format", "validate_phone_number", "validate_pronouns",
        "track_changes", "handle_image_update", "apply_personal_details_changes"
    ]
