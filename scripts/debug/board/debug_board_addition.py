...
def debug_board_addition_flow():
    ...
    try:
        ...
        parko_member = frappe.get_value("Member", {"full_name": "Parko Janssen"}, ["name", "full_name"], as_dict=True)
        parko_volunteer = frappe.get_value("Volunteer", {"volunteer_name": "Parko Janssen"}, ["name", "volunteer_name", "member"], as_dict=True)
