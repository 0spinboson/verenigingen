...
def get_dashboard_data():
	...
	try:
		...
		data["recent_migrations"] = frappe.get_all(
			...
			fields=["name", "migration_name", "migration_status", "progress_percentage", "start_time", "end_time"],
...
def get_system_health():
	...
	try:
		...
		stuck_migrations = frappe.db.count("E-Boekhouden Migration", {
		...
		recent_failures = frappe.db.count("E-Boekhouden Migration", {
