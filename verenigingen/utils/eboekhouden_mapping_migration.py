...
from .eboekhouden_soap_migration import (
    parse_date, get_or_create_supplier, get_or_create_item,
    get_account_by_code, get_expense_account_by_code,
...
def process_purchase_invoices_with_mapping(mutations, company, cost_center, migration_doc):
    ...
    for mut in mutations:
        try:
            ...
            migration_doc.log_error(f"Failed to process invoice {invoice_no}: {str(e)}", "purchase_invoice", mut)
...
def get_mapping_statistics():
    ...
    stats = {
        ...
        "journal_entry_mappings": frappe.db.count("E-Boekhouden Account Mapping", {
            "is_active": 1,
            "document_type": "Journal Entry"
        }),
        "purchase_invoice_mappings": frappe.db.count("E-Boekhouden Account Mapping", {
            "is_active": 1,
    ...
    most_used = frappe.get_all("E-Boekhouden Account Mapping",
    ...
    # Get unused mappings
    unused = frappe.get_all("E-Boekhouden Account Mapping",
