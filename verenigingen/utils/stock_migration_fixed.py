...
class StockMigrationFixed:
    ...
    def migrate_stock_transactions(self, from_date=None, to_date=None):
        ...
        try:
            ...
            if not from_date or not to_date:
                return {
                    "success": False,
                    "error": "Date range required for stock migration"
                }
            ...
            frappe.log_error(
                title="Stock Migration Error",
                message=f"Error in stock migration:\n{error_details}"
            )
    ...
    def _analyze_stock_mutations(self, mutations, stock_accounts):
        ...
        return {
            ...
            "account_summaries": list(account_summary.values())
        }
