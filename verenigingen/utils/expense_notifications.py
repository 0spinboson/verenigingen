...
from frappe.utils import today, getdate, add_days, flt, get_url
...
class ExpenseNotificationManager:
    ...
    def send_approval_confirmation(self, expense_doc):
        ...
        message = self._render_template("expense_approved", {
            "expense": expense_doc,
    ...
    def send_rejection_notification(self, expense_doc, reason):
        ...
        message = self._render_template("expense_rejected", {
            "expense": expense_doc,
            "expense_details": expense_details,
            "volunteer_name": expense_details["volunteer_name"],
    ...
    def send_escalation_notification(self, expense_doc, escalation_reason):
        ...
        message = self._render_template("expense_escalated", {
            "expense": expense_doc,
            "expense_details": expense_details,
    ...
    def send_overdue_reminder(self, days_overdue=7):
        ...
        overdue_expenses = frappe.get_all("Volunteer Expense",
            filters={
                "status": "Submitted",
                "expense_date": ["<=", cutoff_date],
                "docstatus": 1
            },
        ...
        for expense_data in overdue_expenses:
            ...
            for approver_email, approver_name in approvers:
                if approver_email not in approver_reminders:
                    approver_reminders[approver_email] = {
                        "name": approver_name,
                        "expenses": []
                    }
    ...
    def _send_approval_email(self, expense_doc, expense_details, approver_email, approver_name, required_level):
        """Send individual approval request email"""
        subject = f"💰 Expense Approval Required - {expense_doc.name}"
        
        message = self._render_template("expense_approval_request", {
            "expense": expense_doc,
            "expense_details": expense_details,
    ...
    def _send_overdue_reminder_email(self, approver_email, approver_name, expenses, days_overdue):
        ...
        message = self._render_template("expense_overdue_reminder", {
            "approver_name": approver_name,
            "expenses": expenses,
    ...
    def _get_expense_details(self, expense_doc):
        ...
        category_name = frappe.db.get_value("Expense Category", expense_doc.category, "category_name") if expense_doc.category else "Uncategorized"
