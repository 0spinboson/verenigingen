...
class AssignmentHistoryManager:
    ...
    @staticmethod
    def add_assignment_history(volunteer_id: str, assignment_type: str, 
                              reference_doctype: str, reference_name: str,
                              role: str, start_date: str) -> bool:
        """
        ...
        try:
            ...
            for assignment in volunteer.assignment_history or []:
                if (assignment.reference_doctype == reference_doctype and 
                    assignment.reference_name == reference_name and
    ...
    @staticmethod
    def complete_assignment_history(volunteer_id: str, assignment_type: str,
                                  reference_doctype: str, reference_name: str,
                                  role: str, start_date: str, end_date: str) -> bool:
        """
    ...
    @staticmethod
    def get_active_assignments(volunteer_id: str, assignment_type: str = None,
    ...
    @staticmethod
    def remove_assignment_history(volunteer_id: str, assignment_type: str,
                                reference_doctype: str, reference_name: str,
                                role: str, start_date: str) -> bool:
        """
