...
def auto_link_ledgers_to_accounts():
    ...
    try:
        ...
        mappings = frappe.get_all("E-Boekhouden Ledger Mapping",
        ...
        for mapping in mappings:
            ...
            account = frappe.db.get_value("Account", {
                ...
                "account_number": mapping.ledger_code
            }, "name")
            ...
            if not account:
                account = frappe.db.get_value("Account", {
                    "company": "Ned Ver Vegan",
                    "eboekhouden_grootboek_nummer": mapping.ledger_code
                }, "name")
            
            # If found, link it
            if account:
                frappe.db.set_value("E-Boekhouden Ledger Mapping", 
                    mapping.name, 
                    "erpnext_account", 
                    account
                )
...
def check_mapping_status():
    ...
    try:
        ...
        return {
            ...
            "link_percentage": round((linked_mappings / total_mappings * 100), 2) if total_mappings > 0 else 0,
