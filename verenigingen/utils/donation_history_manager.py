...
class DonationHistoryManager:
        ...
        try:
            ...
            donations = frappe.get_all(
                ...
                fields=[
                    ...
                    "donation_status", "fund_designation", "donation_purpose", 
                    "paid", "docstatus"
                ],
                order_by="date desc"
            )
    ...
    def remove_donation_entry(self, donation_name: str):
        ...
        try:
            ...
            return {
                "success": True,
                "message": f"Removed donation {donation_name} from history"
            }
    ...
    def get_donation_summary(self):
        ...
        try:
            ...
            paid_amount = sum(float(entry.donation_amount or 0) for entry in donor.donor_history if entry.paid)
            ...
            if donor.donor_history:
                last_donation_date = max(entry.donation_date for entry in donor.donor_history if entry.donation_date)
