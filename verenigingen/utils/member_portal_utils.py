...
def set_member_home_page(user_email=None, home_page="/member_portal"):
    ...
    try:
        ...
        return {
            "success": True, 
            "message": f"Home page set to {home_page}",
            "home_page": home_page
        }
...
def get_member_portal_stats():
    ...
    try:
        ...
        return {
            ...
            "portal_adoption_rate": round((members_with_portal / total_members) * 100, 2) if total_members > 0 else 0
        }
...
def get_user_appropriate_home_page():
    ...
    system_roles = ["System Manager", "Verenigingen Manager", "Membership Manager"]
