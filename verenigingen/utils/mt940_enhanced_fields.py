...
def create_enhanced_mt940_fields():
    ...
    try:
        ...
        frappe.throw(
            _("Failed to create enhanced MT940 fields: {0}").format(str(e)),
            title=_("Field Creation Error")
        )
...
def remove_enhanced_mt940_fields():
    ...
    try:
        ...
        frappe.throw(
            _("Failed to remove enhanced MT940 fields: {0}").format(str(e)),
            title=_("Field Removal Error")
        )
