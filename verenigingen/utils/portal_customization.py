...
def analyze_current_portal_usage():
    ...
    try:
        ...
        for item in portal_settings.menu:
            ...
            # Categorize items
            erp_items = ["Request for Quotations", "Supplier Quotation", "Purchase Orders", 
                        "Purchase Invoices", "Invoices", "Timesheets", "Material Request",
                        "Quotations", "Orders", "Shipments"]
            
            member_items = ["Member Portal", "My Memberships", "Volunteer Portal", 
                           "My Expenses", "My Addresses", "Issues & Support", 
                           "Addresses", "Projects", "Newsletter"]
...
def get_member_info(user_email):
    ...
    try:
        member = frappe.get_all("Member", 
            ...
            fields=["name", "member_id", "first_name", "last_name", "full_name", "member_since", "email_address"],
            limit=1
        )
        if member:
            return member[0]
...
def add_brand_body_classes(context):
    ...
    verenigingen_paths = [
        'member_portal', 'member_dashboard', 'volunteer_portal', 
        'my_addresses', 'personal_details', 'payment_dashboard',
        'chapter_dashboard', 'my_teams', 'team_members',
        'bank_details', 'apply_for_membership', 'donate',
        'contact_request', 'chapter_join', 'me'
    ]
