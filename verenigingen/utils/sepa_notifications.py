...
class SEPAMandateNotificationManager:
    ...
    def send_payment_success_notification(self, payment_entry):
        ...
        context = {
            ...
            'amount': frappe.utils.fmt_money(payment_entry.paid_amount, currency=payment_entry.paid_to_account_currency),
    ...
    def check_and_send_expiry_notifications(self):
        ...
        expiring_mandates = frappe.get_all(
            ...
            filters={
                'status': 'Active',
                'expiry_date': ['between', [today(), thirty_days_ahead]]
            },
    ...
    def _send_email(self, recipients, subject, template, context, member=None):
        ...
        try:
            ...
            frappe.log_error(f"Failed to send SEPA notification: {str(e)}", 
                           f"SEPA Notification Error - {subject}")
    ...
    def _get_bank_name(self, iban):
        ...
        try:
            from vereiningen.utils.iban_validator import get_bank_from_iban
...
def check_and_send_expiry_notifications():
    ...
    try:
        ...
        frappe.log_error(f"Failed to check SEPA mandate expiry: {str(e)}", 
                       "SEPA Expiry Notification Error")
