...
def check_stock_implications():
    ...
    try:
        ...
        stock_pinvs = frappe.get_all("Purchase Invoice",
            filters={
                "update_stock": 1,
                "docstatus": ["!=", 2]
            },
        ...
        stock_sinvs = frappe.get_all("Sales Invoice",
            filters={
                "update_stock": 1,
                "docstatus": ["!=", 2]
            },
        ...
        return {
            ...
            "recommendation": "Safe to disable perpetual inventory" if not has_stock_transactions else "Review stock transactions before disabling"
        }
