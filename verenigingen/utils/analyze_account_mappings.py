...
def check_tegenrekening_mappings():
    ...
    try:
                ...
                try:
                    ...
                    for row in rows:
                        ...
                        if ledger_id:
                            ...
                            ledger_analysis[ledger_id]["descriptions"].append(cache.description[:50] if cache.description else "")
        ...
        mappings = frappe.get_all("E-Boekhouden Tegenrekening Mapping",
...
def trace_specific_mutation(mutation_id):
    ...
    try:
        ...
        cache = frappe.db.get_value("EBoekhouden REST Mutation Cache",
        ...
        pinv = frappe.db.get_value("Purchase Invoice",
            {"bill_no": invoice_no},
        ...
        sinv = frappe.db.get_value("Sales Invoice",
