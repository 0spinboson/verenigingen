...
class ChapterMembershipManager:
    ...
    @staticmethod
    def join_chapter(member_id: str, chapter_name: str, introduction: str = None,
                    website_url: str = None, user_email: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if user_email and user_email != "Administrator":
                ...
                if user_email != member_doc.email:
                    return {
                        "success": False,
                        "error": _("You don't have permission to perform this action")
                    }
            ...
            if not frappe.db.exists("Member", member_id):
                return {
                    "success": False,
                    "error": _("Member {0} not found").format(member_id)
                }
            ...
            if not frappe.db.exists("Chapter", chapter_name):
                return {
                    "success": False,
                    "error": _("Chapter {0} not found").format(chapter_name)
                }
    ...
    @staticmethod
    def leave_chapter(member_id: str, chapter_name: str, leave_reason: str = None,
                     user_email: str = None, permanent: bool = False) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def assign_member_to_chapter(member_id: str, chapter_name: str, 
                               reason: str = None, assigned_by: str = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def transfer_member_between_chapters(member_id: str, from_chapter: str, 
                                       to_chapter: str, reason: str = None,
        ...
        try:
            ...
            frappe.log_error(f"Error in transfer_member_between_chapters: {str(e)}", "ChapterMembershipManager")
            return {
                "success": False,
                "error": str(e)
            }
    ...
    def get_member_chapter_status(member_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            """, {"member_id": member_id}, as_dict=True)
    ...
    def _update_member_tracking_fields(member_id: str, reason: str, assigned_by: str):
        ...
        try:
            ...
            frappe.log_error(f"Error updating member tracking fields for {member_id}: {str(e)}", "ChapterMembershipManager")
    
    @staticmethod
    def validate_chapter_membership_change(member_id: str, chapter_name: str, 
        ...
        try:
            ...
            if operation == "join":
                ...
                if existing_membership:
                    return {
                        "valid": False,
                        "error": _("Member is already active in this chapter")
                    }
                ...
                if not existing_membership:
                    return {
                        "valid": False,
                        "error": _("Member is not an active member of this chapter")
                    }
