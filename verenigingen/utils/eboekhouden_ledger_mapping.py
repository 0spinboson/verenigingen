...
def fetch_and_create_ledger_mapping():
    ...
    try:
        ...
        if not ledgers:
            return {
                "success": False,
                "error": "No ledgers returned from API"
            }
        ...
        for ledger in ledgers:
            try:
                ...
                existing = frappe.db.exists("E-Boekhouden Ledger Mapping", {
                    "ledger_id": ledger_id
                })
...
def get_account_code_from_ledger_id(ledger_id):
    ...
    # Check mapping table
    ledger_code = frappe.db.get_value("E-Boekhouden Ledger Mapping", {
        "ledger_id": ledger_id
    }, "ledger_code")
...
def create_ledger_mapping_doctype():
    ...
    try:
        ...
        return {
            "success": True,
            "message": "E-Boekhouden Ledger Mapping DocType created successfully"
        }
