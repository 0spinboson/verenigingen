...
class EnhancedAccountMigration:
    ...
    def _determine_type_by_code(self, code):
        """
    ...
    def _get_or_create_parent_account(self, account_data, root_type):
        ...
        group_account = frappe.db.get_value("Account", {
            "company": self.migration_doc.company,
            "eboekhouden_group": group,
            "is_group": 1
        }, "name")
...
def run_enhanced_migration(migration_name):
    ...
    try:
        ...
        account_migrator = EnhancedAccountMigration(migration_doc)
        transaction_migrator = EnhancedTransactionMigration(migration_doc)
        ...
        frappe.log_error(
            title="Enhanced Migration Error",
