...
def get_or_create_item_improved(account_code, company, transaction_type="Both", description=None):
    ...
    from verenigingen.verenigingen.doctype.e_boekhouden_item_mapping.e_boekhouden_item_mapping import get_item_for_account
...
def migrate_existing_items():
    ...
    for item in old_pattern_items:
        ...
        account_info = frappe.db.get_value("Account", {
            "account_number": account_code
        }, ["account_name", "company"], as_dict=True)
