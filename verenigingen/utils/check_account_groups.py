...
def create_missing_account_groups():
    ...
    try:
        ...
        standard_groups = {
            ...
            "002": {"name": "Vlottende activa", "parent": "Application of Funds (Assets) - NVV", "type": "Asset"},
            "003": {"name": "Liquide middelen", "parent": "Current Assets - NVV", "type": "Asset"},
            "004": {"name": "Vorderingen", "parent": "Current Assets - NVV", "type": "Asset"},
            "005": {"name": "Eigen vermogen", "parent": "Source of Funds (Liabilities) - NVV", "type": "Liability"},
        ...
        return {
            "success": True,
            "created": created,
            "message": f"Created {len(created)} account groups"
        }
...
def fix_account_parents():
    ...
    try:
        ...
        parent_mappings = [
            ...
            {"range": (10000, 14999), "parent": "Vorderingen - NVV", "accounts": [
            ...
            {"range": (18000, 19999), "parent": "Schulden - NVV", "accounts": [
                "18100 - Te betalen sociale lasten - NVV",
                "19290 - Te betalen bedragen - NVV"
            ]}
        ]
