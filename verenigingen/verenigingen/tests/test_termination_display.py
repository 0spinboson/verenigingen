...
def test_termination_display():
    ...
    try:
        ...
        if html_field:
            print(f"✓ termination_status_html field found in Member doctype")
    ...
    try:
        from verenigingen.verenigingen.doctype.membership_termination_request.membership_termination_request import get_member_termination_status
