...
class TestVolunteerEdgeCases(FrappeTestCase):
    ...
    def test_email_validation_edge_cases(self):
        ...
        email_test_cases = [
            ...
            ("very.long.email.address.with.many.dots@very-long-domain-name.example.com", True, "Very long email"),
            ("", False, "Empty email"),
        ...
        for email, should_be_valid, description in email_test_cases:
            try:
                volunteer = self.create_test_volunteer(
                    volunteer_name=f"Email Test {self.test_id} {len(self.docs_to_cleanup)}",
                    email=email
                )
                if should_be_valid:
    ...
    def test_status_transitions_edge_cases(self):
        ...
        for from_status, to_status in status_transitions:
            ...
            volunteer.save(ignore_permissions=True)
            volunteer.reload()
            self.assertEqual(volunteer.status, to_status, f"Should transition from {from_status} to {to_status}")
    ...
    def test_skills_and_qualifications_edge_cases(self):
        ...
        skill_categories = ["Technical", "Organizational", "Communication", "Leadership", "Financial", "Event Planning", "Other"]
        ...
        for i, category in enumerate(skill_categories * 3):  # 21 skills total
            volunteer.append("skills_and_qualifications", {
                ...
                "proficiency_level": str((i % 5) + 1) + " - " + ["Beginner", "Basic", "Intermediate", "Advanced", "Expert"][i % 5],
        ...
        special_skills = [
            ...
            ("Leadership", "Very Long Skill Name That Exceeds Normal Expectations " + "X" * 50, "5 - Expert", 15, "")
        ]
    ...
    def test_interest_areas_edge_cases(self):
        ...
        self.assertGreater(len(volunteer.interests), len(available_categories), "Should handle duplicate interests")
        print(f"✅ Duplicate interests handled ({len(volunteer.interests)} entries)")
        
        # Test with non-existent interest category
        try:
            volunteer.append("interests", {
                "interest_area": "Non-Existent Category"
            })
            volunteer.save(ignore_permissions=True)
    ...
    def test_development_goals_edge_cases(self):
        ...
        skills_to_develop = [
            "Public Speaking", "Project Management", "Technical Writing", "Leadership",
            "Financial Management", "Event Planning", "Community Outreach", "Digital Marketing",
            "Data Analysis", "Graphic Design", "Web Development", "Foreign Languages"
        ]
        
        for i, skill in enumerate(skills_to_develop):
            current_level = str((i % 5) + 1) + " - " + ["Beginner", "Basic", "Intermediate", "Advanced", "Expert"][i % 5]
            target_level = str(((i + 2) % 5) + 1) + " - " + ["Beginner", "Basic", "Intermediate", "Advanced", "Expert"][(i + 2) % 5]
        ...
        self.assertEqual(len(volunteer.development_goals), len(skills_to_develop), "Should handle many development goals")
    ...
    def test_data_consistency_edge_cases(self):
        ...
        self.assertTrue(
            final_volunteer.experience_level == "Expert" or 
            final_volunteer.commitment_level == "Intensive",
    ...
    def test_performance_edge_cases(self):
        ...
        volunteer = self.create_test_volunteer(
            volunteer_name=f"Large Data Volunteer {self.test_id}",
            note=large_note
        )
        ...
        for i in range(50):
            ...
            if i < 10:  # Limit interests to available categories
                volunteer.append("interests", {
                    "interest_area": "Testing Category"
                })
        ...
        self.assertLess(creation_time, 10.0, "Large data volunteer creation should complete in reasonable time")
    ...
    def test_validation_edge_cases(self):
        ...
        invalid_scenarios = [
            ...
            },
            {
                ...
                "value": "24/7",
                "description": "Invalid commitment level"
            },
            {
                "field": "preferred_work_style",
                "value": "Underwater",
                "description": "Invalid work style"
            },
            {
                "field": "status",
                "value": "Zombie",
    ...
    def test_internationalization_edge_cases(self):
        ...
        for script_name, intl_text, email in intl_test_cases:
            try:
                volunteer = self.create_test_volunteer(
                    volunteer_name=intl_text,
                    email=email,
                    note=f"Notes with {intl_text} characters"
                )
