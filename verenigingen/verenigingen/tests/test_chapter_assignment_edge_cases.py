...
class TestChapterAssignmentEdgeCases(unittest.TestCase):
    ...
    def test_chapter_transfer_roster_management(self):
        ...
        self.assertNotIn(self.test_member_name, alpha_members_after,
                        "Member should be removed from Alpha roster")
    ...
    def test_roster_corruption_recovery(self):
        ...
        chapter.append("members", {
            ...
            "member_name": f"Test Member{self.test_counter}",
            "enabled": 1
        })
        chapter.save()
    ...
    def test_chapter_with_special_characters(self):
        ...
        # Verify assignment
        member = frappe.get_doc("Member", self.test_member_name)
        self.assertEqual(member.primary_chapter, special_chapter_name,
    ...
    def test_member_with_special_characters(self):
        ...
        self.assertEqual(roster_entry.member_name, "José-María Ñoël-O'Connor",
    ...
    def test_large_chapter_roster_performance(self):
        ...
        for i in range(50):  # Add 50 fake members
            chapter.append("members", {
                "member": f"FAKE-MEMBER-{i:03d}",
                "member_name": f"Fake Member {i}",
                "enabled": 1
            })
        chapter.save()
        ...
        print(f"✅ Large roster performance acceptable: {assignment_time:.3f}s for roster of {len(chapter.members)} members")
    ...
    def test_database_transaction_rollback(self):
        ...
        member.reload()
        self.assertEqual(member.primary_chapter, initial_chapter,
        ...
        for chapter_info in all_chapters:
            ...
            if chapter_info.name != initial_chapter:
                self.assertEqual(len(roster_members), 0,
...
class TestSubscriptionPlanCostFieldEdgeCases(unittest.TestCase):
    ...
    def test_member_subscription_detail_display_with_cost_field(self):
        ...
        self.assertEqual(float(plan_details["price"]), 42.50,
                        "Should use plan_doc.cost for subscription details")
    ...
    def test_cost_field_precision_edge_cases(self):
        ...
        for case_name, cost_value in precision_test_cases:
            ...
            self.assertEqual(retrieved_cost, expected_cost,
