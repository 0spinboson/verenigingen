...
class TestVolunteerInterestCategory(unittest.TestCase):
    ...
    def test_parent_child_relationship(self):
        ...
        parent_of_parent = frappe.get_value("Volunteer Interest Category", 
                                          grandchild.parent_category, 
                                          "parent_category")
    ...
    def test_category_usage_in_volunteer(self):
        ...
        volunteer.append("interests", {
            "interest_area": "Test Parent Category"
        })
        
        # Add child category as interest
        volunteer.append("interests", {
            "interest_area": "Test Child Category"
        })
