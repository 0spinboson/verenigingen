...
def create_import_log(migration_name, import_type, eb_reference, erpnext_doctype=None, erpnext_name=None, import_status="Success", eb_data=None, error_message=None):
