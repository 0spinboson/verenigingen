...
def get_mapping_for_mutation(account_code, description):
    ...
    if account_code:
        ...
        }, ["name", "document_type", "transaction_category"], as_dict=True, order_by="priority desc")
        ...
        mappings = frappe.get_all("E-Boekhouden Account Mapping", 
            ...
            fields=["name", "document_type", "transaction_category", "account_range_start", "account_range_end", "priority"],
...
def create_default_mappings():
    ...
    for mapping_data in default_mappings:
        if not frappe.db.exists("E-Boekhouden Account Mapping", {
            "account_name": mapping_data["account_name"]
        }):
