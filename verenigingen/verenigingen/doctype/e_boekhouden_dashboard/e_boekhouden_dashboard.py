...
class EBoekhoudenDashboard(Document):
    ...
    def generate_dashboard_html(self):
        ...
        try:
            ...
            total_available = (self.accounts_available or 0) + (self.cost_centers_available or 0) + (self.customers_available or 0) + (self.suppliers_available or 0)
    ...
    def generate_recent_migrations_html(self):
        ...
        try:
            ...
            recent_migrations = frappe.get_all(
                ...
                fields=["name", "migration_name", "migration_status", "progress_percentage", "start_time", "end_time", "current_operation"],
