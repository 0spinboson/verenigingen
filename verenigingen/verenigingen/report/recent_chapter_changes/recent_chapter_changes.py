...
def get_data(filters):
    ...
    member_filters = {
        "chapter_assigned_date": [">=", threshold_date]
    }
    ...
    if filters:
        ...
        if filters.get("to_date"):
            if "chapter_assigned_date" in member_filters and isinstance(member_filters["chapter_assigned_date"], list):
...
def get_summary(data):
    ...
    removals = len([d for d in data if "Removed from Chapter" in d.get("change_type", "")])
    ...
    return [
        ...
        {
            "value": transfers,
            "label": _("Chapter Transfers"),
            "datatype": "Int",
            "color": "orange"
        },
        {
            "value": recent_activity,
            "label": _("Changes (Last 7 Days)"),
            "datatype": "Int",
            "color": "purple"
        },
        {
