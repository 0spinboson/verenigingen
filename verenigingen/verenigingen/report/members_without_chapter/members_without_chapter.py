        ...
        try:
            ...
            if city:
                for chapter in chapters:
                    if (chapter.region and 
                        city.lower() in chapter.region.lower()):
                        return chapter.name
...
def get_summary(data):
    ...
    members_with_suggestions = len([d for d in data if d.get("suggested_chapter") != "No suggestion available"])
