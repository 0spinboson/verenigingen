...
def get_context(context):
    ...
    from verenigingen.utils.portal_menu_enhancer import get_user_portal_menu, generate_portal_menu_html
    ...
    member = frappe.db.get_value("Member", {"email": frappe.session.user}, ["name", "first_name", "last_name"])
    if member:
