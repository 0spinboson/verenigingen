...
class DutchTaxExemptionHandler:
    ...
    def create_dutch_tax_templates(self):
        ...
        for exemption_type, description in BTW_CODES.items():
            ...
            tax_template.tax_category = "BTW Vrijgesteld"  # VAT Exempt
    ...
    def setup_btw_codes_in_accounts(self):
        ...
        for exemption_type, description in BTW_CODES.items():
            ...
            existing_account = frappe.db.get_value("Account", {"account_name": account_name, "company": self.company})
            ...
            if not existing_account:
                ...
                if not parent_account:
                    frappe.msgprint(_("Could not find or create BTW parent account. Please create it manually."))
                    continue
    ...
    def get_btw_parent_account(self):
        ...
        btw_accounts = frappe.db.get_value("Account", 
    ...
    def get_tax_account(self, exemption_type):
        ...
        tax_account = frappe.db.get_value("Account", 
            {"account_type": "Tax", "company": self.company, "is_group": 0}, 
            "name")
...
def generate_btw_report(start_date, end_date):
    ...
    invoices = frappe.get_all(
        ...
        fields=[
            "name", "posting_date", "btw_exemption_type", 
            "btw_reporting_category", "base_grand_total"
        ]
    )
