...
class TestStateManager:
    ...
    def validate_transition(self, entity_type, entity_name, expected_from, expected_to):
        ...
        for transition in transitions:
            if (transition["from_state"] == expected_from and 
                transition["to_state"] == expected_to):
                return True
...
class TestDataBuilder:
    ...
    def with_membership(self, membership_type=None, payment_method=None, **kwargs):
        ...
        self._cleanup_manager.register("Membership", membership.name,
                                     dependencies=[f"Member:{self._data['member'].name}"])
    ...
    def with_volunteer_profile(self, **kwargs):
        ...
        self._cleanup_manager.register("Volunteer", volunteer.name,
                                     dependencies=[f"Member:{self._data['member'].name}"])
