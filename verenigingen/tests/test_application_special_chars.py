...
def test_membership_application_special_characters():
    ...
    try:
        ...
        from verenigingen.utils.application_validators import validate_name, check_application_eligibility
        ...
        from verenigingen.utils.application_helpers import generate_application_id, create_address_from_application
