...
class TestSuspensionAPIImportFallback(unittest.TestCase):
    ...
    def test_import_error_triggers_fallback(self, mock_log_error, mock_get_attr):
        ...
        with patch('verenigingen.api.suspension_api._can_suspend_member_fallback', return_value=False) as mock_fallback:
    ...
    def test_fallback_board_member_permission(self, mock_get_value, mock_get_doc, mock_get_roles, mock_session):
    ...
    @patch('frappe.get_doc')
    @patch('frappe.db.get_value')
    def test_fallback_handles_chapter_errors(self, mock_get_value, mock_get_doc, mock_get_roles, mock_session):
    ...
    @patch('frappe.get_doc')
    @patch('frappe.db.get_value')
    def test_fallback_member_without_chapter(self, mock_get_value, mock_get_doc, mock_get_roles, mock_session):
