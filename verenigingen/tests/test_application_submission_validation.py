...
class TestApplicationSubmissionValidation(unittest.TestCase):
    ...
    def test_application_with_volunteer_interest_valid_status(self):
        ...
        self.assertTrue(result.get("success"), f"Application with volunteer interest should succeed: {result}")
        ...
        if result.get("success"):
            ...
            volunteers = frappe.get_all(
                ...
                fields=["name", "status", "volunteer_name"]
            )
    ...
    def test_application_submission_edge_cases(self):
        ...
        if result.get("success"):
            ...
            volunteers = frappe.get_all("Volunteer", filters={"member": member_record}, fields=["name", "status"])
