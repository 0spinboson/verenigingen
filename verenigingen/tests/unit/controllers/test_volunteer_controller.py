...
class TestVolunteerController(VereningingenUnitTestCase):
    ...
    def test_update_aggregated_data_method(self):
        ...
        active_assignments = [a for a in volunteer.assignment_history 
                            if a.status == "Active"]
    ...
    def test_get_skills_by_category_method(self):
        ...
        skills_data = [
            {"skill_category": "Technical", "volunteer_skill": "Python Programming", 
             "proficiency_level": "4 - Advanced"},
            {"skill_category": "Technical", "volunteer_skill": "Database Design", 
             "proficiency_level": "3 - Intermediate"},
            {"skill_category": "Communication", "volunteer_skill": "Public Speaking", 
             "proficiency_level": "4 - Advanced"}
        ]
    ...
    def test_volunteer_status_transitions(self):
        ...
        test_data = (self.builder
            .with_member()
            .with_volunteer_profile(status="New")
            .build())
