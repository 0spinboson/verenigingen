...
class TestMembershipApplicationAPI(VereningingenUnitTestCase):
    ...
    def test_update_application(self):
        ...
        result = membership_application.update_application(member.name, update_data)
    ...
    def test_resend_confirmation_email(self):
        ...
        if hasattr(membership_application, 'resend_confirmation_email'):
            result = membership_application.resend_confirmation_email(member.name)
            
            # Verify email queued
            self.assertions.assert_email_sent(
                member.email,
                subject_contains="Application Confirmation"
            )