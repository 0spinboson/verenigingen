...
class TestTerminationWorkflowEdgeCases(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        frappe.db.sql("DELETE FROM `tabMembership Termination Request` WHERE member IN %s", 
    ...
    def test_termination_audit_trail_creation(self):
        ...
        try:
            audit_entries = frappe.get_all("Termination Audit Entry",
                filters={"termination_request": termination.name})
