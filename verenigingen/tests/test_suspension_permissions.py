...
class TestSuspensionPermissions(unittest.TestCase):
    ...
    def test_can_terminate_member_board_member_same_chapter(self, mock_get_value, mock_get_doc, mock_get_roles):
    ...
    @patch('verenigingen.permissions.frappe.get_doc')
    @patch('verenigingen.permissions.frappe.db.get_value')
    def test_can_terminate_member_board_member_different_chapter(self, mock_get_value, mock_get_doc, mock_get_roles):
    ...
    def test_can_terminate_member_national_chapter_board(self, mock_get_single, mock_get_value, mock_get_doc, mock_get_roles):
    ...
    def test_can_access_termination_functions_board_member(self, mock_get_all, mock_get_value, mock_get_roles):
    ...
    @patch('verenigingen.permissions.frappe.db.get_value')
    @patch('verenigingen.permissions.frappe.get_all')
    def test_can_access_termination_functions_no_board_positions(self, mock_get_all, mock_get_value, mock_get_roles):
