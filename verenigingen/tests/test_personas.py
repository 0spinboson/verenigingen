...
class TestPersonas:
    ...
    def create_happy_path_hannah():
        ...
        test_data = (builder
            .with_chapter("Amsterdam Test Chapter", postal_codes="1000-1099")
            .with_member(
                first_name="Hannah",
                last_name="Happy",
    ...
    def create_payment_problem_peter():
        ...
        test_data = (builder
            .with_chapter("Rotterdam Test Chapter", postal_codes="3000-3099")
            .with_member(
                first_name="Peter",
                last_name="Payment",
    ...
    def create_multi_chapter_mary():
        ...
        if rotterdam_chapter:
            rotterdam_chapter.append("chapter_members", {
