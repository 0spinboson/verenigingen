...
def test_permission_filter_basic():
    ...
    from verenigingen.verenigingen.report.overdue_member_payments.overdue_member_payments import get_user_chapter_filter
...
def test_data_processing_basic():
    ...
    from verenigingen.verenigingen.report.overdue_member_payments.overdue_member_payments import get_summary, get_chart_data
    
    sample_data = [
        {'chapter': 'Test', 'total_overdue': 100, 'overdue_count': 1, 'days_overdue': 30}
    ]
...
def run_payment_smoke_tests():
    ...
    try:
        ...
        return {
            "success": False,
            "message": f"Smoke test execution failed: {str(e)}"
        }
