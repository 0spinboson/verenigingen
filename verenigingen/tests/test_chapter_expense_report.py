...
class TestChapterExpenseReport(unittest.TestCase):
    ...
    def test_execute_returns_proper_structure(self):
        ...
        with patch('verenigingen.verenigingen.report.chapter_expense_report.chapter_expense_report.get_data', return_value=[]):
    ...
    def test_get_summary_with_data(self):
        ...
        test_data = [
            ...
            {'amount': 250.00, 'status': 'Submitted', 'days_to_approval': None, 'approval_level': 'Financial'},
    ...
    def test_get_data_with_filters(self):
        ...
        with patch('verenigingen.verenigingen.report.chapter_expense_report.chapter_expense_report.get_erpnext_expense_data', return_value=mock_expense_data):
            with patch('verenigingen.verenigingen.report.chapter_expense_report.chapter_expense_report.get_user_accessible_chapters', return_value=None):
