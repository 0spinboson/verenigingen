...
from verenigingen.utils.iban_validator import (
    validate_iban, format_iban, validate_iban_checksum, 
    derive_bic_from_iban, get_bank_from_iban
)
    ...
    def test_validate_iban_valid(self):
        ...
        for iban, expected_valid, description in valid_ibans:
            ...
            self.assertEqual(result['valid'], expected_valid, 
                           f"{description}: {iban} - {result.get('message', '')}")
    ...
    def test_derive_bic_from_iban_international(self):
        ...
        for iban, expected_bic in test_cases:
            ...
            self.assertEqual(bic, expected_bic, 
                           f"Non-Dutch IBAN should return None: {iban}")
