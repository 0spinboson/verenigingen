...
from frappe.utils import getdate, format_datetime, get_fullname
...
def get_pending_applications(chapter=None):
    ...
    applications = frappe.get_all(
        ...
        fields=[
            ...
            "application_date", "suggested_chapter", "primary_chapter",
            "postal_code", "city", "country",
            "payment_method", "birth_date", "age"
        ],
    ...
    for app in applications:
        ...
        app["communications"] = frappe.db.count(
            "Communication",
            {"reference_doctype": "Member", "reference_name": app.name}
        )
...
def get_application_stats():
    ...
    # Get pending count
    stats["total_pending"] = frappe.db.count(
        "Member",
...
def bulk_approve_applications(member_names, membership_type, create_invoices=True):
    ...
    for member_name in member_names:
        try:
            ...
            from verenigingen.verenigingen.web_form.membership_application import approve_membership_application
