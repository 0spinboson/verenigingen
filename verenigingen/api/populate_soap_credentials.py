...
def populate_soap_credentials():
    ...
    try:
        ...
        if settings.soap_username:
            return {
                "success": True,
                "message": "SOAP credentials already configured"
            }
        ...
        return {
            "success": True,
            "message": "SOAP credentials populated successfully"
        }
...
def get_soap_credentials_status():
    ...
    return {
        ...
        "has_code1": bool(settings.get_password('soap_security_code1') if hasattr(settings, 'soap_security_code1') else False),
        "has_code2": bool(settings.get_password('soap_security_code2') if hasattr(settings, 'soap_security_code2') else False),
