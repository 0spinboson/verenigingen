...
def create_standard_coa_groups():
    ...
    groups = [
        ...
        # Under Liabilities  
        {"account_name": "Kort Vreemd Vermogen", "parent": root_accounts.get("Liability"), "account_number": "4"},
        {"account_name": "Lang Vreemd Vermogen", "parent": root_accounts.get("Liability"), "account_number": "3"},
        ...
        {"account_name": "Huisvestingskosten", "parent": root_accounts.get("Expense"), "account_number": "62"},
