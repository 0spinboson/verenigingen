...
def create_test_data_onboarding_step():
    ...
    try:
        ...
        existing_step = frappe.db.exists("Onboarding Step", {
            "title": "Generate Test Data",
            "reference_document": "Membership Application"
        })
...
def add_quick_start_card():
    ...
    try:
        ...
        if not has_test_data_card:
            ...
            return {
                "success": True,
                "message": "Quick start card added to workspace"
            }
        else:
            return {
                "success": True,
                "message": "Quick start card already exists"
            }
