...
def complete_sepa_integration_setup():
    ...
    try:
        ...
        try:
            ...
            existing = frappe.db.exists("Custom Field", {"dt": "Bank Transaction", "fieldname": "custom_sepa_batch"})
            if not existing:
        ...
        try:
            ...
            if test_result.get("success"):
                ...
                setup_results.append(f"Test data creation failed: {test_result.get('error', 'Unknown error')}")
        ...
        try:
            ...
            if identify_result.get("success"):
                ...
                setup_results.append(f"Transaction identification working - found {match_count} potential matches")
            else:
                setup_results.append(f"Transaction identification failed: {identify_result.get('error', 'Unknown error')}")
...
def quick_sepa_demo():
    ...
    try:
        ...
        recent_transactions = frappe.get_all("Bank Transaction",
