...
print("   bench --site [your_site] execute \"from verenigingen.tests.test_comprehensive_edge_cases import run_all_edge_case_tests; run_all_edge_case_tests()\"")

print("\n📋 Or run specific test categories:")
print("   bench --site [your_site] run-tests --app verenigingen --module verenigingen.tests.test_security_comprehensive")
print("   bench --site [your_site] run-tests --app verenigingen --module verenigingen.tests.test_performance_edge_cases")
